...
})({"4BA1F":[function(require,module,exports) {
...
function singleLoad(geometry, color, instance) {
    let moveSide = 0;
    if (instance === "grid") // mesh.position.x = 10
    moveSide = right;
    if (instance === "glass") moveSide = left;
...
loader.load("./assets/Cube.obj", (obj)=>singleLoad(obj.children[6].geometry, "white", "glass"));
...
loader.load("./assets/Cube.obj", (obj)=>singleLoad(obj.children[11].geometry, "white", "grid"));
...
},{}]},["4BA1F","6rimH"], "6rimH", "parcelRequire94c2")
